...
<tr id= "navRow">
	...
	<div class="main">
		...
		<div class="itemImage">
          <img src="MN9Shirt.jpg" width="600" height="800">
        </div>
		...
		<div class="itemDescription">
			From the soon to be released spiritual successor<br>
			to the Mega Man Series comes this Mighty No.9<br>
			T-Shirt. Featuring Beck and Call the progonists<br>
			of the game. Go casual with style with this T-Shirt.
			<br>
			<br>
