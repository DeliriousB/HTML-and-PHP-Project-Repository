...
<tr id= "navRow">
	...
	<div class="main">
		<div class="loginform">
			<form name="myform" id="myform" action="LoginCheck.php" method="post">
                <table>
                  ...
                  <tr>
                      <td colspan="2" style="text-align:center"><input type="submit" name="submit" value="Login" onclick="return validate()"></td>
                  </tr>
                </table>
                </form>
		</div>
