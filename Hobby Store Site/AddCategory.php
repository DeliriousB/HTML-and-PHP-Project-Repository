	...
	<?php else : ?>
		...
		<div class="main">
			...
			<div class="registrationForm">
                <form name="myform" id="myform" action="AddCategoryCheck.php" method="post">
                <table>
                  ...
                  <tr>
                      <td colspan="2" style="text-align:center"><input type="submit" name="submit" value="Add Category" onclick="return validate()"></td>
                  </tr>
                </table>
                </form>
            </div>
