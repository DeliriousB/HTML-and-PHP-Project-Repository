...
<tr id= "navRow">
	...
	<div class="main">
		...
		<div class="itemImage">
          <img src="TeraSlayerElin1.jpg" width="600" height="800">
        </div>
		...
		<div class="addToCart">
          <a href="Cart.php"><img src="AddToCart.png" width="215" height="105"></a>
        </div>

		 
		<div class="itemHead">
			Tera Slayer Elin Figure
		</div>
		<br>
		<div class="itemDescription">
			From the popular MMO game Tera Online comes <br>
			a figure of an Elin character as a Slayer. This <br>
			figure stands just shy of 11 inches at 275mm.
			<br>
			<br>
			<u>Specifications</u><br>
			Size: 275mm<br>
			Maker: Flare<br>
			Contents: Figure, Mirrored Base, Youko Mask
