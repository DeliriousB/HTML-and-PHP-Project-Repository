...
<tr id= "navRow">
	...
	<?php else : ?>
		...
		<div class="main">
			...
			$pdo = new PDO('mysql:host=localhost:3306;dbname=JHobby', 'root', '');
			$stmt = $pdo->prepare("INSERT INTO products (ProductName, Category, Stock, ItemImage1, ItemImage2, Cost, Description) VALUES (:ProductName, :Category, :Stock, :ItemImage1, :ItemImage2, :Cost, :Description)");
			$stmt->bindParam(':ProductName', $ProductName);
			$stmt->bindParam(':Category', $Category);
			$stmt->bindParam(':Stock', $Stock);
			$stmt->bindParam(':ItemImage1', $ItemImage1);
			...
			$Stock = $_POST['Stock'];
			$ItemImage1 = $_POST['ItemImage1'];
			$ItemImage2 = $_POST['ItemImage2'];
			$Cost = $_POST['Cost'];
