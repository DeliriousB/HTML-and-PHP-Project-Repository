...
<tr id= "navRow">
	<div class="menuPartTwo">
		...
		<div class="main3">
			<div class="loginform">
			<form name="myform" id="myform" action="PaymentCheck.php" method="post">
                <table>
				
				  <tr>
                    <td>Card Name*: </td><td><input type="text" name="CardName" required/></td>
                  </tr>

				  </tr>
                    <td>CardNumber*: </td><td><input type="text" name="CreditCard" required/></td>
                  </tr>
				  
				  </tr>
                    <td>CCV*: </td><td><input type="text" name="CCV" required/></td>
                  </tr>
				  
                  <tr>
                      <td colspan="2" style="text-align:center"><input type="submit" name="submit" value="Continue" onclick="return validate()"></td>
                  </tr>
                </table>
                </form>
		</div>
